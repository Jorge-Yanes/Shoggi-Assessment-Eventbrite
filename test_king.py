...
class TestClass(unittest.TestCase):
    ...
    def test_move_is_possible(self):
        for a in range(8):
            ...
            piece_1 = Piece(player=1, piece_symbol='K',crowned=False)

            # Piece at the final position
            finish_piece = None

            # One cell fordward, allowed movement where the final cell is empty
            self.assertTrue( King.move_is_possible(None, Cell(column=a, row=a ), Cell(column=a, row=a+1 ), piece_1, finish_piece))
            ...
            self.assertTrue( King.move_is_possible(None, Cell(column=a, row=a ), Cell(column=a+1, row=a ), piece_1, finish_piece))
            ...
            self.assertTrue( King.move_is_possible(None, Cell(column=a, row=a ), Cell(column=a+1, row=a+1 ), piece_1, finish_piece))
            ...
            self.assertFalse( King.move_is_possible(None, Cell(column=a+randint(2,8), row=a+randint(2,8) ), Cell(column=a-1, row=a+1 ), piece_1, finish_piece))
            ...
            self.assertFalse( King.move_is_possible(None, Cell(column=a, row=a ), Cell(column=a+1, row=a+1 ), piece_1, finish_piece))

            #Starting and finishing cells are the same
            self.assertFalse( King.move_is_possible(None, Cell(column=a, row=a ), Cell(column=a, row=a ), piece_1, finish_piece))
